...
@section('title', 'Catálogos - Estados Ventas')
...
@endpush
    ...
    @section('nombreSeccion', 'Catálogos - Estados Ventas')

    @section('bread')

        <li class="breadcrumb-item"><a href="{{route('admin.home')}}"><i class="feather icon-home"></i></a></li>
        <li class="breadcrumb-item"><a href="#!">Cátalogos</a></li>
        <li class="breadcrumb-item"><a href="#!">Estados Venta</a></li>
