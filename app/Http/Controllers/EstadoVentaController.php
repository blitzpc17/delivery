...
class EstadoVentaController extends Controller
{
    public function index(){
        ...
        return view('Admin.sistema.catalogos.estados_venta', compact('user', 'rol', 'menu'));
    }
    ...
    public function save(Request $r){
        try{
            ...
            if($r->id==null){
               VentaEstado::create($data);
            }else{
                VentaEstado::where('id', $r->id)->update($data);
            }
    ...
    public function listar(){
        return VentaEstado::all();
    }

    public function obtener(Request $r){
        return VentaEstado::where('id', $r->id)->first();
    }

    public function delete(Request $r){
        try{
            VentaEstado::where('id', $r->id)->delete();
            return response()->json(["status"=>200, "msj"=>"success"]);
    ...
    public function ListarEstadosVentasSelect(Request $r){
